...
- **Commercial angle**: self-serve first — every tool has a free tier; Pro is $29–$39/month per tool (NursEpod $39; others $29), month-to-month. Secondary thread: "prove it, then share it with your team". The phrase "no practice sign-off" was removed from all pages and automation copy by owner request (2026-09-12) — do not re-add it anywhere.
