...
typography:
  # — reading + chrome ramp —
  body:    { fontFamily: "Montserrat", cqw: 0.95, weight: 500, lineHeight: 1.6 }
  card-title:{ fontFamily: "Montserrat", cqw: 1.15, weight: 700, upper: true, lineHeight: 1.2 }
  ...
  heading-md:{ fontFamily: "Montserrat", cqw: 2.1, weight: 700, lineHeight: 1.1, tracking: "-0.01em", upper: true }
  quote-text:{ fontFamily: "Montserrat", cqw: 2.7, weight: 900, lineHeight: 1.15, tracking: "-0.02em", upper: true }
  stat-number:{ fontFamily: "Montserrat", cqw: 3.3, weight: 900, lineHeight: 1.0 }
  heading-lg:{ fontFamily: "Montserrat", cqw: 3.3, weight: 800, lineHeight: 1.0, tracking: "-0.02em", upper: true }
  close-title:{ fontFamily: "Montserrat", cqw: 4.2, weight: 900, lineHeight: 0.95, tracking: "-0.03em", upper: true }
  heading-xl:{ fontFamily: "Montserrat", cqw: 5.0, weight: 900, lineHeight: 0.95, tracking: "-0.03em", upper: true }
