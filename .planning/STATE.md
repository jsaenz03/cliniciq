...
- Blog page now at root: `blog.html` (primary)
- Blog posts remain at `blog/` subdirectory
- Blog navigation consistent across all HTML pages
- All links updated to point to `blog.html`
- All blog posts now have complete Open Graph and Twitter Card meta tags
- Legal pages (privacy-policy.html, terms-of-service.html) now have complete social sharing metadata
