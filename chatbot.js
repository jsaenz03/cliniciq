  ...
  transitionToChatInterface(userName) {
    ...
    if (welcomeMessage) {
      ...
      if (messageContent) {
        ...
        helperP.textContent = "Happy to help with our tools for practice nurses — NursEpod, Docsert AI, the calculators — or booking a consultation. What would you like to know?";
